...
export async function HeaderPro() {
        ...
        <div className="flex items-center justify-end gap-1 flex-1">
            <div className="flex items-center justify-start md:justify-end gap-1 flex-1">
                ...
                <Link
                    ...
                    target="_blank"
                    className="hidden group relative md:inline-flex items-center gap-2 px-3 py-1.5 text-sm rounded-lg bg-zinc-900 dark:bg-zinc-100 transition-colors hover:bg-zinc-800 dark:hover:bg-zinc-200"
                >
                    <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-gray-500 to-zinc-500 opacity-40 group-hover:opacity-80 blur transition-opacity duration-500" />
