...
```bash tab="bun"
bunx shadcn@latest add https://kokonutui.com/r/particle-button -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://kokonutui.com/r/particle-button -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://kokonutui.com/r/particle-button -c ./apps/www
```
